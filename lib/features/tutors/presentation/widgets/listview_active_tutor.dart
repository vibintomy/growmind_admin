...
class ListviewActiveTutor extends StatelessWidget {
  const ListviewActiveTutor({super.key});
                            ...
                            IconButton(
                                onPressed: () async {
                                  if (await canLaunchUrl(
                                    ...
                                    await launchUrl(Uri.parse(tutor.pdfUrl),
                            ...
                            Row(
                              children: [
                                ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      final userDocValues = FirebaseFirestore
                                          .instance
                                          .collection('kyc')
                                          .doc(tutor.id);
                                ...
                                ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      final tutorDocRef = FirebaseFirestore
                                          .instance
                                          .collection('kyc')
                                          .doc(tutor.id);
                                      await tutorDocRef
